	...
	basic() {
		...
		public void actionPerformed(ActionEvent e){
			...
			if(txtFields[0].getText().isBlank() || txtFields[1].getText().isBlank() || txtFields[2].getText().isBlank() || txtFields[3].getText().isBlank() || txtFields[4].getText().isBlank() || txtFields[5].getText().isBlank()){
				...
				int dialog = JOptionPane.showConfirmDialog(this, "Do you want to save the row?", "Saving", JOptionPane.YES_NO_OPTION);
				...
				if(dialog == 0){
					...
					JOptionPane.showMessageDialog(this,"Please enter number on stocks and re-order point.", "Unsupported Input", JOptionPane.WARNING_MESSAGE);
			...
			int dialog = JOptionPane.showConfirmDialog(this, "Are you sure to cancel?", "Cancel...", JOptionPane.YES_NO_OPTION);
			...
			if(table.getSelectedRow() == -1){
				JOptionPane.showMessageDialog(this,"Please select row.", "No row selected", JOptionPane.WARNING_MESSAGE);
			}

			else if(table.isRowSelected(selectedrow)){
				int dialog = JOptionPane.showConfirmDialog(this, "Do you want to delete the selected row?", "Delete Row", JOptionPane.YES_NO_OPTION);
			...
			if(rowselected == -1){
				JOptionPane.showMessageDialog(this, "Select row and try again.", "No row selected", JOptionPane.WARNING_MESSAGE);
			}
				...
				try{
					...
					JOptionPane.showMessageDialog(this, "Enter number on stocks. Please try again", "Input Error", JOptionPane.WARNING_MESSAGE);
					table.getSelectionModel().clearSelection();
					for(int i=0; i<=txtFields.length-1; i++){
						txtFields[i].setText("");
	   ...
	   //
			...
			try{
				...
				JOptionPane.showMessageDialog(this,"Please enter number on stocks and re-order point.", "Unsupported Input", JOptionPane.ERROR_MESSAGE);
