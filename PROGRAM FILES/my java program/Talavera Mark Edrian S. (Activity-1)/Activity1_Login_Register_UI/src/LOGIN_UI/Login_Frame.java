...
public final class Login_Frame extends JFrame implements ActionListener {
	...
	ImageIcon img4 = new ImageIcon(new ImageIcon("sp-.png").getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
	ImageIcon img5 = new ImageIcon(new ImageIcon("unsee.png").getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
	...
	//	String password =(new String(PassField.getPassword()));
		...
		if(e.getSource().equals(Login)) {
			...
			if (username.isBlank()) {
			...
			else if(user.equals(usertxt.getText()) && pass.equals(new String(PassField.getPassword()))) {
				...
				dash.name.setText(Firstname +" " +Middlename +" "+ Lastname);
				dash.name1st=Firstname;
				dash.name2nd=Lastname;
				dash.middleinitial=Middlename;
				dash.username1st=user;
				dash.password1st=pass;
		...
		if (e.getSource().equals(Cancel)) {
			int ext = JOptionPane.showConfirmDialog(this, "Are you want to exit?", "Exit", JOptionPane.YES_NO_OPTION);
