		...
		if(e.getSource().equals(confirm)) {    	
	    	if (Fname.getText().isEmpty() || LName.getText().isEmpty() || MI.getText().isEmpty() ||username.isBlank() || password.isEmpty()||confirmPassword.isEmpty()){
	            JOptionPane.showMessageDialog(this, "Please fill in all fields.", "Error", JOptionPane.ERROR_MESSAGE);
		 		...
		 		JOptionPane.showMessageDialog(this, "Minimum of 5 characters on Username!", "Invalid Input", JOptionPane.ERROR_MESSAGE);	
		 	}
...
//reset all textFields----------------------------------------------------------------------------------------------------------------------------		
		...
		if(e.getSource()==reset) {
			int reset = JOptionPane.showConfirmDialog(this, "Are you want to Reset all Fields ?", "Confirm", JOptionPane.YES_NO_OPTION);
...
//Cancel the creating----------------------------------------------------------------------------------------------------------------------------		
		...
		if (e.getSource().equals(Cancel)) {
			int ext = JOptionPane.showConfirmDialog(this, "Are you want to Cancel?", "Exit", JOptionPane.YES_NO_OPTION);
