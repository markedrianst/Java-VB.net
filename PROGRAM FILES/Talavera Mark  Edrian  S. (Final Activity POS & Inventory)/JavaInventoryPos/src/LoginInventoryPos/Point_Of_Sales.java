...
public class Point_Of_Sales extends JFrame implements ActionListener {
	ImageIcon img = new ImageIcon(new ImageIcon("bgdash.jpg").getImage().getScaledInstance(1040, 740, Image.SCALE_SMOOTH));
...
//Quantity Search------------------------------------------------------------------------------------------------	       
		...
		Search.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null,"Empty inputs./Please Fill The Quantity" ,"invalid" , JOptionPane.OK_OPTION);			
				}
				...
				JOptionPane.showMessageDialog(null," Quantity can't contain letters" ,"invalid" , JOptionPane.OK_OPTION);	
			}}	
		});	
		addbutton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				String ekwals = table.getValueAt(selected,5).toString();
				int ekwals1 = Integer.parseInt(ekwals);
				int enteredQuantity1 = Integer.parseInt(quant.getText());
				if(enteredQuantity1>ekwals1) {
					JOptionPane.showMessageDialog(null, "Insuficients Stocks", "Invalid", JOptionPane.WARNING_MESSAGE);
				}
				else if(selected == -1){
				...
				try{
					...
					int intstk = Integer.parseInt(fours);
                    int intqty = Integer.parseInt(fives); 
                    int intttl = intstk - intqty;
                    if (intttl >= Integer.parseInt(val)) {
                        model.setValueAt("High Stock", selected, 7);
                    } else if (intttl > 0 && intttl < Integer.parseInt(val)) {
                        model.setValueAt("Low Stock", selected, 7);
                    } else if (intttl <= 0) {
                        model.setValueAt("Out of Stock", selected, 7);
                    }
		 ...
		 buttons[2].addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        if (dizcountzpanel.getComponentCount() == 0) {
		        	...
		        	dizcountzpanel.setBounds(0, 0, 500, 400);
                    ...
                    for (int a = 0; a < rdtxt.length; a++) {
                        ...
                        rdBtn[a].setFont(new Font("Arial", Font.BOLD,15));
		        ...
		        discountdialogs.setSize(500, 400);
                ...
                public void actionPerformed(ActionEvent e) {
                	...
                	if (selectedRowIndex != -1) { 
                            ...
                            double newdiscount =0.00;

                            newdiscount -= (originalTotal - discountedTotal);
                            newTotalAmount=newdiscount+totalAmount;
                            
                         
                            container.setText(String.valueOf(newTotalAmount));
                            totals.setText(String.valueOf('\u20B1' +" "+container.getText()));
                           
                            discountdialogs.dispose();
                            RadioGroup.clearSelection();
                    }else if (!rdBtn[0].isSelected()||!rdBtn[1].isSelected()||!rdBtn[2].isSelected()||!rdBtn[3].isSelected()) {
                		JOptionPane.showMessageDialog(null,"Select Discount", "Select ", JOptionPane.ERROR_MESSAGE);					
           ...
           @Override
            public void actionPerformed(ActionEvent e) {
        	   if (table1.getRowCount() == 0) {
        		    JOptionPane.showMessageDialog(null, "Theres no Item to pay." ,"invalid" , JOptionPane.OK_OPTION);
        		} else {
	           ...
	           okaybtn.addActionListener(new ActionListener() {
	            ...
	            if (paymentAmount < TotalAmount) {
	            	...
	            	dialogreceipt.setUndecorated(true);
	            	...
	            	Paymentbtn.setBounds(195, 520, 60, 20);
	            	...
	            	Paymentbtn.addActionListener(new ActionListener() {
	            		...
	            		public void actionPerformed(ActionEvent e) {
	            			...
	            			payements.setText(String.valueOf(""));
	            	...
	            	rpt.setBounds(0, 10, 400, 40);
	            	rpt.setFont(new Font("Bell MT", Font.BOLD, 28));
	            	panelok.add(rpt);	            	
	            	
	            	JLabel invoiceno = new JLabel("  Invoice No : "+"...................................................... "+ defaults.getText() ,JLabel.CENTER);
	            	invoiceno.setBounds(0, 50, 400, 20);
	            	invoiceno.setFont(new Font("Arial", Font.BOLD, 13));
	            	panelok.add(invoiceno);
	            	
	            	JLabel date = new JLabel("   Date of Purcahse : "+"................................ "+ dateLabel.getText() ,JLabel.CENTER);
	            	date.setBounds(10,70, 400, 20);
	            	date.setFont(new Font("Arial", Font.BOLD, 13));
	            	panelok.add(date);
	            	
	            	JLabel time = new JLabel("  Time of Purcahse : "+"............................................ "+ timeLabel.getText() ,JLabel.CENTER);
	            	time.setBounds(10,90, 400, 20);
	            	time.setFont(new Font("Arial", Font.BOLD, 13));
	            	panelok.add(time);
	            	
	            	JLabel code = new JLabel("*** ACKNOWLEDGEMENT RECEIPT ***",JLabel.CENTER);
	            	code.setBounds(10, 110, 400, 40);
	            	code.setFont(new Font("Bell MT", Font.BOLD, 15));
	            	panelok.add(code);
	            	
	            	JLabel dash = new JLabel("==============================================");
	            	dash.setBounds(20, 130, 460, 40);
	            	dash.setFont(new Font("Bell MT", Font.BOLD, 14));
	            	panelok.add(dash);

	            	JLabel dash1 = new JLabel("==============================================");
	            	dash1.setBounds(20, 375, 460, 40);
	            	dash1.setFont(new Font("Bell MT", Font.BOLD, 14));
	            	panelok.add(dash1);

	            	JLabel pc1 = new JLabel("Total Amount : " + ".....................................................  "+'\u20B1' +" "+ totalAmount);
	            	pc1.setBounds(40, 395, 460, 40);
	            	pc1.setFont(new Font("Arial", Font.BOLD, 13));
	            	panelok.add(pc1);
	            	
	            	JLabel pc2 = new JLabel("Total Discount : " + "......................................................  "+'\u20B1' +" "+ discountAmount);
	            	pc2.setBounds(40, 415, 460, 40);
	            	pc2.setFont(new Font("Arial", Font.PLAIN, 13));
	            	panelok.add(pc2);
	            	
	            	JLabel pc3 = new JLabel("Total Amount Inserted : " + "...........................................  "+'\u20B1' +" "+ paymentAmount);
	            	pc3.setBounds(40, 435, 460, 40);
	            	pc3.setFont(new Font("Arial", Font.PLAIN, 13));
	            	panelok.add(pc3);
	            	
	            	JLabel pc4 = new JLabel("Change : " + "................................................................  "+'\u20B1' +" "+ changeAmount);
	            	pc4.setBounds(40, 455, 460, 40);
	            	pc4.setFont(new Font("Arial", Font.PLAIN, 13 ));
	            	panelok.add(pc4);
	            	
	            	JLabel dash3 = new JLabel("==============================================");
	            	dash3.setBounds(20, 475, 460, 40);
	            	dash3.setFont(new Font("Bell MT", Font.BOLD, 14));
	            	panelok.add(dash3);

	            	JLabel purchase = new JLabel("Thank you for purchasing");
	            	purchase.setBounds(160, 490, 250, 40);
	            	purchase.setFont(new Font("Arial", Font.PLAIN, 12));
	            	panelok.add(purchase);
	            	
	            	JScrollPane scrollPane = new JScrollPane();
	            	scrollPane.setBounds(0, 160, 460, 220);
	            	scrollPane.setBackground(new Color(255,255,255,0));
	            	scrollPane.setOpaque(false);
	            	scrollPane.setBorder(BorderFactory.createMatteBorder(0,1,0,1,Color.BLACK));
	            	...
	            	for (String item : items) {
	            		...
	            		label.setBounds(y, 160, 100, 30);
	            		label.setFont(new Font("Arial", Font.BOLD, 12));
	            		dialogreceipt.add(label);
	            		y += 70;
	            	}
...
//cancel Button-------------------------------------------------------------------------------------------------
		if(e.getSource()==buttons[4])	{
			...
			if (Conf == JOptionPane.YES_OPTION) {  
				//double deletedTotal = Double.parseDouble( model1.getValueAt(i, 5);.toString()); 
			
	         for (int i = 0; i < model1.getRowCount(); i++) {
	        	 
	        	 String items = (String) model1.getValueAt(i, 0);	            	
	        	 DefaultTableModel inventoryModel = (DefaultTableModel) table.getModel();
	        	 int inventoryRowIndex = -1;
	        	 
	        	 for (int y = 0; y < inventoryModel.getRowCount(); y++) {
	        		 if (inventoryModel.getValueAt(y, 0).equals(items)) {
	        			 inventoryRowIndex = y;
	        			 break;
	        		 }
	        	 }
